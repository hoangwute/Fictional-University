...
<?php } 
 ...
 function universityFiles() {
 	...
 	wp_enqueue_script("googleMap", '//maps.googleapis.com/maps/api/js?key=AIzaSyCYLRoR1XTMw83-rzT1jpHCfbK_TzsTL38', NULL, microtime(), true);
 ...
 function universityMapKey($api) {
 	$api['key'] = 'AIzaSyCYLRoR1XTMw83-rzT1jpHCfbK_TzsTL38';
 	return $api;
 }

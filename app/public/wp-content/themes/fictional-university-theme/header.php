...
<head>
	...
	<meta name="viewport" content="width=device-width, initial-scale = 1"> <!-- adapt to mobile devices -->
	<?php wp_head(); ?>
</head>
<body <?php body_class(); ?>>
		...
		<div class="container">
			...
			<div class="site-header__menu group">
				<nav class="main-navigation">
					<ul>
						<li <?php if (is_page('about-us') || wp_get_post_parent_id(get_the_ID()) == 11) echo 'class="current-menu-item"'; ?>><a href="<?php echo site_url("/about-us");?>">About Us</a></li>
